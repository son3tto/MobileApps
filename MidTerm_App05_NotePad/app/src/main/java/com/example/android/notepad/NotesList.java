...
public class NotesList extends ListActivity {
    ...
    private static final String[] PROJECTION = new String[]{
            ...
            NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE //TODO
    };
...
/*    void startSetting(Menu menu){
        MenuItem mSetting = findViewById(R.id.menu_setting);
        Toast.makeText(getApplicationContext(), "打开设置", Toast.LENGTH_LONG).show();
        mSetting.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
...
//
//
//        MenuItem mPasteItem = findViewById(R.id.menu_paste);
//
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_setting:
                ...
                settingIntent.setClass(NotesList.this, SettingActivity.class);
